...
// import galleryImagesData from "./data/gallery_images";
...
const Welcome = () => {
  ...
  const loadGalleryImagesData = async() => {
    const resp = await fetch('https://xn4plip8pj.execute-api.us-east-2.amazonaws.com/Production/gallery_images');
